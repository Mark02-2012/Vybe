                              ...
                              onPressed: () async {
                                if (FFAppState().isDownloading) {
                                  ...
                                  if (selectedFiles != null) {
                                    safeSetState(() => _model
                                        .isDataUploading_uploadData03uu = true);
                                    ...
                                    try {
                                      ...
                                      _model.isDataUploading_uploadData03uu =
                                          false;
                                    }
                                    if (selectedUploadedFiles.length ==
                                        selectedFiles.length) {
                                      safeSetState(() {
                                        _model.uploadedLocalFile_uploadData03uu =
                                  ...
                                  FFAppState().addToLibreriaDownload(
                                      CanzoneLocaleStruct(
                                    titolo: widget!.titolo,
                                    autore: widget!.autore,
                                    percorsofile: _model
                                        .uploadedLocalFile_uploadData03uu
                                        .originalFilename,
                                    copertina: widget!.copertina,
                                  ));
                                  safeSetState(() {});
                                } else {
                                  await Clipboard.setData(ClipboardData(
                                      text:
                                          'https://www.youtube.com/watch?v=${widget!.videoID}'));
                                  await launchURL('https://media.ytmp3.gg/it/');
                                  FFAppState().isDownloading = true;
                                  safeSetState(() {});
                                }
                              },
                            ),
