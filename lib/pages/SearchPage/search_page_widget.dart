                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    onFieldSubmitted: (_) async {
                      _model.apiResult7wf = await YouTubeSearchCall.call(
                        searchQuery: _model.textController.text,
                      );

                      if ((_model.apiResult7wf?.succeeded ?? true)) {
                        safeSetState(() {});
                      } else {
                  ...
                  children: [
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Builder(
                          builder: (context) {
                            final canzoniYT = getJsonField(
                              (_model.apiResult7wf?.jsonBody ?? ''),
                              r'''$.items''',
                            ).toList();
                            ...
                            return SingleChildScrollView(
                              ...
                              child: Column(
                                mainAxisSize: MainAxisSize.max,
                                children: List.generate(canzoniYT.length,
                                        (canzoniYTIndex) {
                                  final canzoniYTItem =
                                      canzoniYT[canzoniYTIndex];
                                  return InkWell(
